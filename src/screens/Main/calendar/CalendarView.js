            ...
            {/* <ScrollView> */}
                ...
                {/* <View style={styles.modeSwitch}>
                    ...
                    onPress={() => setMode('month')}>
                        <SemiBoldText style={[styles.modeBtn, mode === 'month' && styles.activeMode]}>월별</SemiBoldText>
                    </TouchableOpacity>
                    <TouchableOpacity
                    onPress={() => setMode('week')}>
                        <SemiBoldText style={[styles.modeBtn, mode === 'week' && styles.activeMode]}>주별</SemiBoldText>
                    </TouchableOpacity>
                </View> */}
                ...
                <View style={styles.calendarGrid}>
                    {dates.map((date) => (
                        // const ongoingEvent = events.filter(e => 
                        //     dayjs(date).isBetween(dayjs(e.start), dayjs(e.end),  null, '[]')
                        // );

                        // const isStart = ongoingEvent && dayjs(date).isSame(dayjs(ongoingEvent.start), 'day');
                        // const isEnd = ongoingEvent && dayjs(date).isSame(dayjs(ongoingEvent.end), 'day');
                        <TouchableOpacity
                ...
                <Modal visible={detailModalVisible} transparent animationType="fade">
                    <View style={styles.modalContainer}>
                        <View style={styles.modalContent}>
                            ...
                            <RegularText style={styles.modalSub}>{selectedEvent?.start} ~ {selectedEvent?.end}</RegularText>
                            <View style={styles.modalButtons}>
                                <TouchableOpacity
